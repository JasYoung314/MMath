...
def func(n):
    ...
    while True :
        ...
        Object9 = StaticHeuristic.simulation(lmbda,mu,c,skip,3600)
        ...
        outfile = open('./Static/MDP/Comparisons/out/DataSimmHeuristics.csv','ab')
        ...
        outrow.append(SimmPolicy[2].str())
