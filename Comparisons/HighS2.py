# This file was *autogenerated* from the file /home/c1012211/Static/MDP/Comparisons/HighS2.sage.
...
def func(n):
    while True :
        ...
        mu = [random.uniform(Integer(2),Integer(5)),random.uniform(Integer(5),Integer(10))]
        c = [random.randint(Integer(2),Integer(4)),random.randint(Integer(4),Integer(7))]
