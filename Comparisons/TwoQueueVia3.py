# This file was *autogenerated* from the file TwoQueueVia3.sage.
from sage.all_cmdline import *   # import sage library
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_4 = Integer(4); _sage_const_0p1 = RealNumber('0.1'); _sage_const_10 = Integer(10); _sage_const_20 = Integer(20); _sage_const_19 = Integer(19)
class Queue: #A class for the queueing system
    #def __init__(self,lmbda,mu,C,beta,Policy = matrix([[0,0,2,2,2],[0,0,0,0,2],[1,1,1,2,2]])):
    def __init__(self,lmbda,mu,C,beta,Policy  = _sage_const_7 ,bounds = [_sage_const_20 ,_sage_const_20 ]):
        self.lmbda = lmbda
        self.mu = mu
        self.beta = beta
        self.servers = C
        ...
        self.Pmu1 = (mu[_sage_const_0 ]*C[_sage_const_0 ])/(lmbda + sum([C[e]*mu[e] for e in range(_sage_const_2 )]))
        ...
        for e in range((self.Selfish[_sage_const_0 ] +_sage_const_1  )):
            for k in range((self.Selfish[_sage_const_1 ] + _sage_const_1 ) ):
                if e < self.servers[_sage_const_0 ] or k < self.servers[_sage_const_1 ]:
        ...
        for e in self.states:
            if self.Policy == _sage_const_7 :
                if e[_sage_const_0 ] < self.Selfish[_sage_const_0 ] - _sage_const_1  and e[_sage_const_1 ] < self.Selfish[_sage_const_1 ] - _sage_const_1 :
                    self.ADict['%s' %e] = [_sage_const_0 ,_sage_const_1 ,_sage_const_2 ]
                elif e[_sage_const_0 ] >= self.Selfish[_sage_const_0 ] - _sage_const_1    and e[_sage_const_1 ] < self.Selfish[_sage_const_1 ] - _sage_const_1   :
                ...
                if e[_sage_const_0 ] < self.Selfish[_sage_const_0 ] - _sage_const_2  and e[_sage_const_1 ] < self.Selfish[_sage_const_1 ] - _sage_const_2 :
                    self.ADict['%s' %e] = [self.Policy[e[_sage_const_0 ],e[_sage_const_1 ]]]
                elif e[_sage_const_0 ] >= self.Selfish[_sage_const_0 ] - _sage_const_2  and e[_sage_const_1 ] < self.Selfish[_sage_const_1 ]  - _sage_const_2 :
                    self.ADict['%s' %e] = [_sage_const_1 ,_sage_const_2 ]
                elif e[_sage_const_0 ] < self.Selfish[_sage_const_0 ] - _sage_const_2  and e[_sage_const_1 ] >= self.Selfish[_sage_const_1 ] - _sage_const_2  :
                    self.ADict['%s' %e] = [_sage_const_0 ,_sage_const_2 ]
                elif e[_sage_const_0 ] >= self.Selfish[_sage_const_0 ] - _sage_const_2  and e[_sage_const_1 ] >= self.Selfish[_sage_const_1 ] - _sage_const_2 :
    ...
    def findP(self): #Converts Q to P
        ...
        for e  in range(self.P.nrows()):
            ...
            for k in range(self.P.nrows()):
                if self.states[e][_sage_const_0 ] == _sage_const_19 :
    ...
    def Cost(self,state,action):
        ...
        if state[-_sage_const_1 ] == _sage_const_2  or state[-_sage_const_1 ] == _sage_const_3 :
            return _sage_const_0 
        ...
        if state[-_sage_const_1 ] == _sage_const_0 :
            ...
            for a in self.ADict['%s' %([state[_sage_const_0 ],state[_sage_const_1 ]])]:
                ...
                for e in self.VIAStates:
                    ...
                    eventtype =_sage_const_10 
                    if e[_sage_const_0 ] == NewState[_sage_const_0 ] and e[_sage_const_1 ] == NewState[_sage_const_1 ] and not e[-_sage_const_1 ] == _sage_const_0 :
                        if NewState[_sage_const_0 ] < self.servers[_sage_const_0 ] or NewState[_sage_const_1 ] < self.servers[_sage_const_1 ]:
                            eventtype = _sage_const_3 
                        else:
                            eventtype = _sage_const_1 

                    elif e[_sage_const_0 ] == min(NewState[_sage_const_0 ] + _sage_const_1 ,self.Selfish[_sage_const_0 ]) and e[_sage_const_1 ] == NewState[_sage_const_1 ] :
                        eventtype = _sage_const_0 
                    elif e[_sage_const_0 ] == NewState[_sage_const_0 ] - _sage_const_1  and e[_sage_const_1 ] == min(NewState[_sage_const_1 ] + _sage_const_1 ,self.Selfish[_sage_const_1 ]):
                        eventtype = _sage_const_1 
                    elif e[_sage_const_0 ] == NewState[_sage_const_0 ]  and e[_sage_const_1 ] == NewState[_sage_const_1 ] - _sage_const_1  :
                        eventtype = _sage_const_2 

                    if eventtype == e[-_sage_const_1 ] and not self.TranProbs['%s' %([NewState[_sage_const_0 ],NewState[_sage_const_1 ]])]['%s' %([e[_sage_const_0 ],e[_sage_const_1 ]]) ] == _sage_const_0 :
            ...
            for e in self.VIAStates:
                eventtype = _sage_const_10 
                if e[_sage_const_0 ] == state[_sage_const_0 ] and e[_sage_const_1 ] == state[_sage_const_1 ] and not e[-_sage_const_1 ] == _sage_const_0 :
                    if state[_sage_const_0 ] < self.servers[_sage_const_0 ] or state[_sage_const_1 ] <self.servers[_sage_const_1 ]:
                        eventtype = _sage_const_3 
                    else:
                        eventtype = _sage_const_1 
                elif e[_sage_const_0 ] == state[_sage_const_0 ] + _sage_const_1  and e[_sage_const_1 ] == state[_sage_const_1 ] :
                    eventtype = _sage_const_0 
                elif e[_sage_const_0 ] == state[_sage_const_0 ] - _sage_const_1  and e[_sage_const_1 ] == min(state[_sage_const_1 ] + _sage_const_1 ,self.Selfish[_sage_const_1 ]):
                    eventtype = _sage_const_1 
                elif e[_sage_const_0 ] == state[_sage_const_0 ]  and e[_sage_const_1 ] == state[_sage_const_1 ] - _sage_const_1  :
                    eventtype = _sage_const_2 

                if eventtype == e[-_sage_const_1 ] and not self.TranProbs['%s' %([state[_sage_const_0 ],state[_sage_const_1 ]])]['%s' %([e[_sage_const_0 ],e[_sage_const_1 ]]) ] == _sage_const_0 :
    ...
    def VIA(self,epsilon = _sage_const_0p1 ):
        ...
        while not end:
            ...
            print  'LongRunAve =  %.02f' %self.StateValues[T]['%s'%([_sage_const_0 ,_sage_const_0 ,_sage_const_0 ])]
        ...
        if self.Policy == _sage_const_7 :
            for e in self.VIAStates:
                ...
                if e[-_sage_const_1 ] == _sage_const_0  and e[_sage_const_0 ] <= self.Selfish[_sage_const_0 ] and e[_sage_const_1 ] <= self.Selfish[_sage_const_1 ]:
