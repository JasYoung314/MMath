# This file was *autogenerated* from the file MDPFormulation2.sage.
from sage.all_cmdline import *   # import sage library
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_40 = Integer(40); _sage_const_0p1 = RealNumber('0.1'); _sage_const_10 = Integer(10); _sage_const_20 = Integer(20)
class Queue: #A class for the queueing system
    #def __init__(self,lmbda,mu,C,beta,Policy = matrix([[0,0,2,2,2],[0,0,0,0,2],[1,1,1,2,2]])):
    def __init__(self,lmbda,mu,C,beta,Policy = False):
        self.lmbda = lmbda
        self.mu = mu
        self.beta = beta
        self.servers = C
        ...
        if state[-_sage_const_1 ] == _sage_const_0 :
            ...
            if state[_sage_const_0 ] < self.Selfish[_sage_const_0 ] and  state[_sage_const_1 ] < self.Selfish[_sage_const_1 ]:
                    ...
                    for e in self.VIAStates:
                        ...
                        if eventtype == e[-_sage_const_1 ]:
                            if eventtype == _sage_const_0  :
                                ...
                                Value += self.TranProbs['%s' %([NewState[_sage_const_0 ],NewState[_sage_const_1 ]])]['%s' %([e[_sage_const_0 ],e[_sage_const_1 ]]) ]*self.StateValues[T - _sage_const_1 ]['%s' %([min([e[_sage_const_0 ],self.Selfish[_sage_const_0 ]]),e[_sage_const_1 ],eventtype])]
                    ...
                    for e in self.VIAStates:
                        ...
                        if eventtype == e[-_sage_const_1 ]:
                            if eventtype == _sage_const_0  :
                                ...
                                Value += self.TranProbs['%s' %([NewState[_sage_const_0 ],NewState[_sage_const_1 ]])]['%s' %([e[_sage_const_0 ],e[_sage_const_1 ]]) ]*self.StateValues[T - _sage_const_1 ]['%s' %([e[_sage_const_0 ],min([e[_sage_const_1 ],self.Selfish[_sage_const_1 ]]),eventtype])]
                ...
                for a in self.ADict['%s' %([state[_sage_const_0 ],state[_sage_const_1 ]])]:
                    ...
                    objective.append(Value)
                return Value,self.ADict['%s' %([state[_sage_const_0 ],state[_sage_const_1 ]])][objective.index(min(objective))]
        else:
            if state[_sage_const_0 ] < self.Selfish[_sage_const_0 ] and  state[_sage_const_1 ] < self.Selfish[_sage_const_1 ]:
