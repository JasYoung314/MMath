        ...
        if state[-1] == 0:
            ...
            if state[0] < self.Selfish[0] and  state[1] < self.Selfish[1]:
                ...
                for a in [1,2]:
                    ...
                    objective.append(Value)
                return min(objective),objective.index(min(objective)) + 1
                ...
                for a in [2]:
                    ...
                    objective.append(Value)
                return min(objective),objective.index(min(objective))+2
            else:
