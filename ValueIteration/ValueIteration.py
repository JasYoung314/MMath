# This file was *autogenerated* from the file ValueIteration.sage.
from sage.all_cmdline import *   # import sage library
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_10 = Integer(10); _sage_const_0p5 = RealNumber('0.5'); _sage_const_0p00000000001 = RealNumber('0.00000000001'); _sage_const_20 = Integer(20); _sage_const_0p01 = RealNumber('0.01')
class Queue: #A class for the queueing system
    def __init__(self,lmbda,mu,C,R,Thresh = False,epsilon = _sage_const_0p01 ):
        ...
        self.states = []
        self.Selfish =  _sage_const_2 *int(R*mu*C) - _sage_const_1 
    ...
    def ValueIter(self,T=_sage_const_1 ,StartingState = [_sage_const_0 ,_sage_const_0 ]): #Recursively calculates cost for current state
       ...
       while not end:
                ...
                if e[_sage_const_0 ] == _sage_const_0  or e[_sage_const_0 ] >= self.servers:
                    ...
                    if e[_sage_const_1 ] == _sage_const_0 :
                        ...
                        for i in self.A:
                            ...
                            ActionValues.append(self.Cost(e[_sage_const_0 ],i) + self.P2[_sage_const_1 ]*self.StateValues[T-_sage_const_1 ]['%s' %( [e[_sage_const_0 ]+i,_sage_const_0 ] )] + self.Pij(e[_sage_const_0 ],e[_sage_const_0 ])*self.StateValues[T-_sage_const_1 ]['%s' %([e[_sage_const_0 ],_sage_const_1 ])] + self.Pij(e[_sage_const_0 ],e[_sage_const_0 ]-_sage_const_1 )*self.StateValues[T-_sage_const_1 ]['%s' %([e[_sage_const_0 ] + i - _sage_const_1 ,_sage_const_1 ])] )
            ...
            RefVal =self.StateValues[T]['%s' %([_sage_const_0 ,_sage_const_1 ])]
       ...
       print self.StateValues[T - _sage_const_1  ]['%s' %([_sage_const_0 ,_sage_const_1 ])]
       return self.P2[_sage_const_1 ]*self.StateValues[T - _sage_const_1 ]['%s' %([_sage_const_0 ,_sage_const_0 ])],OptimalPolicy
       #return self.StateValues[T - 1],OptimalPolicy

Simple = Queue(_sage_const_2 ,_sage_const_3 ,_sage_const_6 ,_sage_const_0p5 ,epsilon = _sage_const_0p00000000001 )

Results = Simple.ValueIter()
print Results[_sage_const_0 ]
